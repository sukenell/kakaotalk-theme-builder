const IOS_COLOR_BINDINGS = [
  ...
  ["HeaderStyle-Main", "-ios-tab-text-color", "titleText"],
  ["HeaderStyle-Main", "-ios-tab-highlighted-text-color", "titlePressed"],
  ...
  ["BottomBannerStyle", "background-color", "mainBackground"],
  ["BottomBannerStyle-Light", "background-color", "mainBackground"],
  ...
  ["BackgroundStyle-ChatRoom", "background-color", "mainBackground"],
...
const ANDROID_COLOR_BINDINGS = {
  ...
  theme_chatroom_background_color: "mainBackground",
  theme_passcode_background_color: "mainBackground",
  ...
  theme_tab_lightbannerbadge_background_color: "mainBackground",
  theme_tab_bannerbadge_background_color: "mainBackground",
